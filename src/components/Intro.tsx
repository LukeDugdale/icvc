...
export function Intro() {
  return (
    <>
      ...
      <h1 className="mt-14 text-3xl font-display  font-light text-white">
        Decentralised venture capital{' '}
        <span className="text-purple-400 ">for the Internet Computer</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
      ICVC is a decentralised venture capital fund, 
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      ...
      <IconLink href="https://twitter.com/icvc_xyz" icon={TwitterIcon} compact large>
        icvc_xyz
      </IconLink>
    </p>
  )
